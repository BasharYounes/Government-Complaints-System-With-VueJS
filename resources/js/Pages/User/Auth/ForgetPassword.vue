...
const submit = () => {
    form.post('/forget-password', {
        onSuccess: () => console.log('تم إرسال الرمز بنجاح'),
        onError: () => {},
    });
};
...
<template>
    <Head title="إعادة إرسال رمز التحقق — نظام إدارة الشكاوى الحكومية" />
    ...
    <div class="page-wrapper">
        <!-- Background Elements (نفس الخلفية المستخدمة في الصفحات السابقة) -->
        ...
        <div class="resend-container">
            <div class="resend-card">
                ...
                <div class="card-header">
                    ...
                    <h1 class="card-title"> إرسال رمز التحقق</h1>
                    <p class="card-subtitle">
                        أدخل البريد الإلكتروني المسجل لديك<br>
                        وسيتم إرسال رمز التفعيل
                    </p>
                </div>

                <!-- Form -->
                <form @submit.prevent="submit" class="resend-form">
                    <div class="field">
